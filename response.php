...
<style>
	...
	th 		 { font-size:12px;background:#FCA116;color:#FFFFFF;font-weight:bold;height:30px;}
	td 		 { font-size:12px;background:#FFD5AA}
	.pageTitle { font-size:24px;}
</style>
</HEAD>
<BODY LEFTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0 bgcolor="#ECF1F7">
<center>
   <table width='100%' cellpadding='0' cellspacing="0" ><tr><th width='90%'><h2 class='co'>&nbsp;Online
     Payment</h2></th></tr></table>
...
<?php
		...
		//if($key!="DeliveryName"||"DeliveryAddress"||"DeliveryCity"||"DeliveryState"||"DeliveryPostalCode"||"DeliveryCountry"||"DeliveryPhone")
